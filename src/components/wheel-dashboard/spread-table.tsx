      ...
      <table className="w-full min-w-[1430px] border-collapse text-left text-sm whitespace-nowrap">
        <thead className="bg-[#1b1d1e] text-xs uppercase text-zinc-400">
          <tr>
            ...
            <th className="sticky left-[156px] z-20 w-[180px] min-w-[180px] border-r border-white/10 bg-[#1b1d1e] px-4 py-3 font-medium">
              Short/Long
            </th>
            {[
              "Width",
        ...
        <tbody>
          {rows.map((row) => (
            ...
            >
              ...
              <td className="sticky left-[156px] z-10 w-[180px] min-w-[180px] border-r border-white/10 bg-[#151718] px-4 py-3 font-mono group-hover:bg-[#1b1d1e]">
                <button
